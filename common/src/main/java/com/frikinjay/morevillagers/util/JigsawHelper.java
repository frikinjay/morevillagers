...
public class JigsawHelper {
    ...
    public static void addBuildingToPool(HolderLookup<StructureTemplatePool> templatePoolRegistry, HolderLookup<StructureProcessorList> processorListRegistry, ResourceLocation poolRL, String nbtPieceRL, int weight) {
        Holder<StructureProcessorList> emptyProcessorList = processorListRegistry.getOrThrow(EMPTY_PROCESSOR_LIST_KEY);

        Holder.Reference<StructureTemplatePool> poolHolder = templatePoolRegistry.getOrThrow(ResourceKey.create(Registries.TEMPLATE_POOL, poolRL));
